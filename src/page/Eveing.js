...
export default function Eveing() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch("precious-exploration-production.up.railway.app/users", {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch("precious-exploration-production.up.railway.app/check/" + Id + "/" + userID, {
          method: "GET",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    ...
    function handleOptionChange(index, value) {
      ...
      const DoUpdate = async (Id) => {
        ...
        const response = await fetch("precious-exploration-production.up.railway.app/updateEvening/"+ Id,
          {
            method: "PUT",
            headers: {
              Accept: "application/json",
