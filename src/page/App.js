...
export default function App() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch("precious-exploration-production.up.railway.app/check/" + 0, {
          method: "GET",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  function handleOptionChange(index, value) {
    ...
    const DoUpdate = async () => {
      ...
      const response = await fetch("precious-exploration-production.up.railway.app/updateMorning",
        {
          method: "PUT",
          headers: {
            Accept: "application/json",
